...
namespace Config
{
    ...
    constexpr bool useSmiley = false; ///{"options":["true","false"]}
    constexpr uint8_t startupMood = 3;            // 0=distracted, 1=excited, 2=moody, 3=focused -- ///{"range":[0,3]}
    ...
    // PID Gains
    constexpr float Kp = 0.3f; ///{"min":0,"max":10}
    constexpr float Ki = 0.03f; ///{"min":0,"max":1}
    constexpr float Kd = 0.1f; ///{"min":0,"max":1}
    ...
    constexpr uint16_t moodySlumpTarget = 100; ///{"min":130,"max":770}
