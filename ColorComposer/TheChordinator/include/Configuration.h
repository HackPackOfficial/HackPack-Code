...
DEFINE_CHORD(scale_FMajPentatonic_3octave, "F2", "G2", "A2", "C3", "D3", "F3", "G3", "A3", "C4", "D4", "F4", "G4", "A4", "C5", "D5");

// A Minor Pentatonic - The most common minor pentatonic, very versatile
DEFINE_CHORD(scale_AMinPentatonic_3octave, "A2", "C3", "D3", "E3", "G3", "A3", "C4", "D4", "E4", "G4", "A4", "C5", "D5", "E5", "G5");

// Bb Major Pentatonic - mellow and rounded
DEFINE_CHORD(scale_BbMajPentatonic_3octave, "Bb2", "C3", "D3", "F3", "G3", "Bb3", "C4", "D4", "F4", "G4", "Bb4", "C5", "D5", "F5", "G5");
...
{
  {
    &scale_FMajPentatonic_3octave, ///{"options":["&scale_FMajPentatonic_3octave","&scale_AMinPentatonic_3octave","&scale_BbMajPentatonic_3octave","&scale_EbPentatonicMinor","&scale_CPentatonicMajor","&scale_CHarmonicMajor","&scale_CLydian","&scale_CDorian","&scale_CWholeTone","&scale_CDiminishedHalfWhole","&scale_CBlues","&scale_CMelodicMinor","&scale_CHirajoshi","&scale_CHungarianMinor","&scale_CPhrygianDominant","&scale_FMajPentatonic","&scale_BbMajPentatonic","&scale_AMinPentatonic","&scale_DHirajoshi","&scale_GEgyptian","&scale_EKumoi","&scale_DIwato"]}
    &scale_AMinPentatonic_3octave, ///{"options":["&scale_AMinPentatonic_3octave","&scale_FMajPentatonic_3octave","&scale_BbMajPentatonic_3octave","&scale_EbPentatonicMinor","&scale_CPentatonicMajor","&scale_CHarmonicMajor","&scale_CLydian","&scale_CDorian","&scale_CWholeTone","&scale_CDiminishedHalfWhole","&scale_CBlues","&scale_CMelodicMinor","&scale_CHirajoshi","&scale_CHungarianMinor","&scale_CPhrygianDominant","&scale_FMajPentatonic","&scale_BbMajPentatonic","&scale_AMinPentatonic","&scale_DHirajoshi","&scale_GEgyptian","&scale_EKumoi","&scale_DIwato"]}
    &scale_BbMajPentatonic_3octave ///{"options":["&scale_BbMajPentatonic_3octave","&scale_FMajPentatonic_3octave","&scale_AMinPentatonic_3octave","&scale_EbPentatonicMinor","&scale_CPentatonicMajor","&scale_CHarmonicMajor","&scale_CLydian","&scale_CDorian","&scale_CWholeTone","&scale_CDiminishedHalfWhole","&scale_CBlues","&scale_CMelodicMinor","&scale_CHirajoshi","&scale_CHungarianMinor","&scale_CPhrygianDominant","&scale_FMajPentatonic","&scale_BbMajPentatonic","&scale_AMinPentatonic","&scale_DHirajoshi","&scale_GEgyptian","&scale_EKumoi","&scale_DIwato"]}
  }, 
