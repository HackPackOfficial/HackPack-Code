...
// constexpr uint8_t LEFT_TOUCH_PAD_PIN = A0;   // You can add more touch pads if you want!
constexpr uint8_t RIGHT_TOUCH_PAD_PIN = A7;
constexpr int16_t TOUCH_THRESHOLD = 100;        // readings above this value will be considered an active touch. This may need tuning for each unique sensor pad. -- ///{"min":0,"max":1023}
