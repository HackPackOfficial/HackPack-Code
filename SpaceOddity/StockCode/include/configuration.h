...
// Mid travel of the servo (90 degrees). Kept as a reference for the servo range.
constexpr uint8_t SERVO_CENTER        = 90;   // Range: 0 to 180
...
const char* const MENU_LABELS[MENU_ITEM_COUNT] = {"SWIM", "DRAW", "DANCE"};
